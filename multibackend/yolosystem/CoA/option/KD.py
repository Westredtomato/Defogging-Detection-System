...
parser.add_argument('--epochs', type=int, default=20)#总迭代次数
parser.add_argument('--iters_per_epoch', type=int, default=5000)#每个epoch的迭代次数
parser.add_argument('--finer_eval_step', type=int, default=100000)#多少步后进行更精细的评估
