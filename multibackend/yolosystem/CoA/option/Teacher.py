...
parser.add_argument('--model_type', type=str, default='Teacher', help='which teacher model to use: Teacher or DehazeNet')
...
#这里训练的实验路径要修改
parser.add_argument('--saved_model_dir', type=str, default='CoA/experiment/Teacher/THaze/saved_model')
parser.add_argument('--saved_data_dir', type=str, default='CoA/experiment/Teacher/THaze/saved_data')
